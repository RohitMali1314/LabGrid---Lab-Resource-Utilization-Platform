      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <ChartCard title="Demand Trend" description="Requests per day">
          {trend.loading ? (
            ...
            <EmptyState
              title="No trend data"
              description="Demand trends appear once bookings are recorded."
            />
          ) : (
      ...
      <div className="rounded-xl border bg-card">
        <div className="border-b p-4">
          ...
          <p className="text-xs text-muted-foreground">
            Cross-institution demand comparison.
          </p>
        </div>
        <EmptyState
          title="Coming soon"
          description="Cross-institution demand comparison is not available yet."
        />
      </div>
    </div>
  );
